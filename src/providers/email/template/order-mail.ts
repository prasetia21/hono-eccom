import { formatEmailDate } from "@/shared/utils/date";
                    ...
                    <tr style="vertical-align:top">
                      ...
                      <td style="padding-left:10px">
                        ...
                        <p style="color:rgba(49,53,59,0.96);margin:0 0 5px 0;font-weight:bold;font-size:12px">
                          ${d.o_detail_qty ?? 0} X ${formatIDR(d.o_detail_product_price ?? 0).replace("Rp ", "Rp ")}
                        </p>
                      </td>
                    </tr>
                  </tbody>
...
export function orderMail(params: { order: MailV2Order; urlAsset: string }) {
        ...
        <tr>
          <td>
            ...
            <table align="center" cellpadding="0" cellspacing="0" style="margin-top:20px;">
              ...
              <tr>
                <td>
                  <h2 style="color: #444444;font-size: 22px;font-weight: bold;margin-top: 10px;margin-bottom: 10px;padding-bottom: 0;text-transform: uppercase;display: inline-block;line-height: 1;">Pesanan Diterima</h2>
                </td>
              </tr>
            </table>

            <p style="margin: 30px 0 5px 0;font-size:14px;">Hai <b>${custName}</b>,</p>
            <p style="margin: 0px 0 0 0;font-size:14px;">Pesanan anda telah kami terima, pesanan anda akan segera kami proses.</p>
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="left" style="margin:0 0 20px 0;width: 100%;">
              ...
              <tr>
                ...
                <td colspan="3" class="price" style="line-height: 35px;text-align: right;padding-right: 0px;font-size: 13px;color: #000000;text-align:right;border-left: unset;border-collapse: collapse; padding-bottom: 20px;">
